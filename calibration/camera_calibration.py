...
CHECKERBOARD_ROWS = 5  # Number of squares along the height - 1
CHECKERBOARD_COLS = 5  # Number of squares along the width - 1
...
SQUARE_SIZE = 0.9  # e.g., 2.5 for 2.5 cm squares
